...
export InFile1="../../../test/data/c1/scenario_01/case.con"
export InFile2="../../../test/data/c1/scenario_01/case.inl"
export InFile3="../../../test/data/c1/scenario_01/case.raw"
export InFile4="../../../test/data/c1/scenario_01/case.rop"
